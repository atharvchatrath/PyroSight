...
GRAMMAR: Dict[str, List[Tuple[str, ...]]] = {
    ...
    "LOCATE_VICTIM": [("locate", "victim"), ("victim",), ("find", "person"),
                      ("locate", "person"), ("survivor",), ("casualty",)],
    ...
    "HIDE_LABELS": [("hide", "label"), ("label", "off"), ("hide", "text"),
                    ("declutter",)],
    "SHOW_LABELS": [("show", "label"), ("label", "on")],
    "BRIGHTNESS_UP": [("increase", "brightness"), ("brighter",),
                      ("brightness", "up"), ("more", "bright")],
    "BRIGHTNESS_DOWN": [("lower", "brightness"), ("decrease", "brightness"),
                        ("dimmer",), ("brightness", "down"), ("dim",)],
    "EMERGENCY_MODE": [("emergency", "mode"), ("emergency",), ("mayday",),
                       ("panic",)],
    "EXIT_EMERGENCY": [("exit", "emergency"), ("cancel", "emergency"),
                       ("all", "clear"), ("clear", "emergency")],
    "SEARCH_MODE": [("search", "mode"), ("search", "room"), ("start", "search"),
                    ("guided", "search")],
...
ACKS: Dict[str, str] = {
    ...
    "HIDE_LABELS": "LABELS HIDDEN",
    "SHOW_LABELS": "LABELS SHOWN",
    "BRIGHTNESS_UP": "BRIGHTNESS UP",
    "BRIGHTNESS_DOWN": "BRIGHTNESS DOWN",
    "EMERGENCY_MODE": "⚠ EMERGENCY MODE ENGAGED",
    "EXIT_EMERGENCY": "EMERGENCY MODE CLEARED",
    "SEARCH_MODE": "OBJECTIVE: GUIDED SEARCH",
...
def available_commands() -> List[Dict[str, str]]:
    examples = {
        "FIND_EXIT": "find exit",
        "LOCATE_VICTIM": "locate person",
        "RETURN_TO_ENTRY": "return to entry",
        "SEARCH_MODE": "search room",
        ...
        "BRIGHTNESS_DOWN": "lower brightness",
        "EMERGENCY_MODE": "emergency mode",
        "EXIT_EMERGENCY": "cancel emergency",
